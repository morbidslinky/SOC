...
namespace SOC.Classes.Common
{
    public static class NPCBodyInfo
    {
        ...
        public static BodyInfoEntry[] BodyInfoArray = {
             new BodyInfoEntry(
                "AFGH_HOSTAGE",
                new LuaTableIdentifier("TppDefine", new LuaString("QUEST_BODY_ID_LIST"), new LuaString("AFGH_HOSTAGE_MALE")),
            ...
            new BodyInfoEntry(
                "AFGH_HOSTAGE_FEMALE",
                new LuaTableIdentifier("TppDefine", new LuaString("QUEST_BODY_ID_LIST"), new LuaString("AFGH_HOSTAGE_FEMALE")),
            ...
            new BodyInfoEntry(
                "MAFR_HOSTAGE",
                new LuaTableIdentifier("TppDefine", new LuaString("QUEST_BODY_ID_LIST"), new LuaString("MAFR_HOSTAGE_MALE")),
            ...
            new BodyInfoEntry(
                "MAFR_HOSTAGE_FEMALE",
                new LuaTableIdentifier("TppDefine", new LuaString("QUEST_BODY_ID_LIST"), new LuaString("MAFR_HOSTAGE_FEMALE")),
            ...
            new BodyInfoEntry(
                "DRAB",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds3_main0_v00")),
            ...
            new BodyInfoEntry(
                "DRAB_FEMALE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds8_main0_v00")),
            ...
            new BodyInfoEntry(
                "TIGER",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds5_main0_v00")),
            ...
            new BodyInfoEntry(
                "TIGER_FEMALE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds6_main0_v00")),
            ...
            new BodyInfoEntry(
                "SNEAKING_SUIT",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds4_enem0_def")),
            ...
            new BodyInfoEntry(
                ...
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds4_enef0_def")),
            ...
            new BodyInfoEntry(
                "BATTLE_DRESS",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds5_enem0_def")),
            ...
            new BodyInfoEntry(
                "XOF_GASMASK",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("wss0_main0_v00")),
            ...
            new BodyInfoEntry(
                "XOF",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("wss4_main0_v00")),
            ...
            new BodyInfoEntry(
                "MSF_TPP",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dds0_main1_v00")),
            ...
            new BodyInfoEntry(
                "WANDERING_MSF",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("pfs0_dds0_v00")),
            ...
            new BodyInfoEntry(
                "SOVIET_BERET",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("svs0_unq_v010")),
                "/Assets/tpp/parts/chara/svs/svs0_main0_def_v00.parts",
                "/Assets/tpp/pack/mission2/common/mis_com_afgh.fpk",
                false,
                false
            ...
            new BodyInfoEntry(
                "SOVIET_HOODIE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("svs0_unq_v060")),
                "/Assets/tpp/parts/chara/svs/svs0_main0_def_v00.parts",
                "/Assets/tpp/pack/mission2/common/mis_com_afgh.fpk",
                false,
                false
            ...
            new BodyInfoEntry(
                "SOVIET_SOLDIER",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("svs0_snp_v00_b")),
                "/Assets/tpp/parts/chara/svs/svs0_main0_def_v00.parts",
                "/Assets/tpp/pack/mission2/common/mis_com_afgh.fpk",
                false,
                false
            ...
            new BodyInfoEntry(
                "PF_C_BERET",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("pfs0_unq_v450")),
            ...
            new BodyInfoEntry(
                "PF_SOLDIER",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("pfs0_snp_v00_a")),
                "/Assets/tpp/parts/chara/pfs/pfs0_main0_def_v00.parts",
                "/Assets/tpp/pack/mission2/common/mis_com_mafr.fpk",
                false,
                false
            ...
            new BodyInfoEntry(
                "SWIMWEAR_GW",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlf_enem0_def")),
            ...
            new BodyInfoEntry(
                "SWIMWEAR_GW_FEMALE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlf_enef0_def")),
            ...
            new BodyInfoEntry(
                "SWIMWEAR_GOB",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlg_enem0_def")),
            ...
            new BodyInfoEntry(
                "SWIMWEAR_GOB_FEMALE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlg_enef0_def")),
            ...
            new BodyInfoEntry(
                "SWIMWEAR_MEG",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlh_enem0_def")),
            ...
            new BodyInfoEntry(
                "SWIMWEAR_MEG_FEMALE",
                new LuaTableIdentifier("TppEnemyBodyId", new LuaString("dlh_enef0_def")),
    ...
    public struct BodyInfoEntry
    {
        ...
        public LuaTableIdentifier gameId { get; set; }
        ...
        public BodyInfoEntry(string name, LuaTableIdentifier id, string parts, string pack, bool female, bool face)
        {
            Name = name;
            gameId = id;
            partsPath = parts;
